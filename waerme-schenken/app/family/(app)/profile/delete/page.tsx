...
export default function FamilyDeleteProfilePage() {
    ...
    if (success) {
        return (
            <div className="min-h-screen flex items-center justify-center px-5" style={{ backgroundColor: BRAND.beige }}>
                <div className="bg-white rounded-[8px] p-10 shadow-sm flex flex-col items-center text-center max-w-sm w-full">
    ...
    return (
        <div className="min-h-screen pt-12 px-5 pb-24" style={{ backgroundColor: BRAND.beige }}>
            <div className="max-w-md mx-auto">
                <Link href="/family/profile" className="flex items-center gap-2 mb-8 font-bold text-sm hover:opacity-70">
                ...
                <div className="bg-white rounded-[8px] p-7 shadow-sm mb-6">
                    ...
                    <p className="opacity-70 text-sm text-center leading-relaxed mb-6">{de.profile.deleteConfirm}</p>
                    <p className="text-[12px] opacity-50 text-center mb-6">
                        Ausgewählte, noch nicht gesendete Spielzeuge werden freigegeben und zurück in die Börse gestellt.
                    </p>
                    ...
                    <button onClick={handleDelete} disabled={!confirmed || loading}
                        className="mx-auto h-10 min-w-[143px] px-6 rounded-full text-white font-bold uppercase tracking-widest text-[12px] flex items-center justify-center disabled:opacity-40"
                        style={{ backgroundColor: BRAND.error, fontFamily: "'Bricolage Grotesque',sans-serif" }}>
                        {loading ? 'Löschen...' : 'Profil löschen'}
                    </button>
                </div>

                <Link href="/family/profile" className="block text-center text-sm font-bold underline opacity-50 hover:opacity-100">
                    Abbrechen
                </Link>
            </div>
        </div>
